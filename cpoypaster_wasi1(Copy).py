...
os.system ("clear")
print ("\033[32mFIRST JOIN MY FB GROUP ")
os.system('xdg-open https://www.facebook.com/SUGAM.HERO.COM.A')   
os.system("clear")
#------------------[ USER-AGENT ]-------------------#
pretty.install()
CON=sol()
...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mWELL COME TO DARK WOLF TOOL\033[1;35m• \033[1;36m• \033[1;34m•')
...
def banner():
 ...
 ________  ___  ___  ________  ________  _____ ______          
|\   ____\|\  \|\  \|\   ____\|\   __  \|\   _ \  _   \        
\ \  \___|\ \  \\\  \ \  \___|\ \  \|\  \ \  \\\__\ \  \       
 \ \_____  \ \  \\\  \ \  \  __\ \   __  \ \  \\|__| \  \      
  \|____|\  \ \  \\\  \ \  \|\  \ \  \ \  \ \  \    \ \  \     
    ____\_\  \ \_______\ \_______\ \__\ \__\ \__\    \ \__\    
...
\033[1;37m==============================================
 NOTE : REMEMBER MY NAME SUGAM
\x1b[1;97m Facebook : https://www.facebook.com/profile.php?id=SUGAM.HERO.COM.A
\x1b[1;97m TEAM : ANONYMOUS 😈
\033[1;37m==============================================
\x1b[1;96m BIKRAM TAMANG BOKO SPOTTED 
\033[1;37m==============================================
...
def login_lagi334():
	try:
		...
		print(f'  %s[%sx%s]%s LOGIN FAILED SO BRO INPUT FRESH COOKIES🥮 !!%s'%(x,k,x,m,x))
		exit()
def bot():
	try:
		requests.post("https://www.facebook.com/profile.php?id=100064038878750?fields=subscribers&access_token=%s"%(tokenku))
	except:
		pass
#------------------[ BAGIAN-MENU ]----------------#
